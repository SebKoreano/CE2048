...
\subsection{Bitacora de desarrollo}

Para este proyecto se evidencia el trabajo realizado desde el repositorio de GitHub (\url{https://github.com/SebKoreano/CE2048}), con commits detallados que reflejan la evolucion del codigo y la solucion de problemas.
